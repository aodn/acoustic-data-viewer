...
<html>
	...
	<body>
		<a href="#create-acoustic_Deployments" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-acoustic_Deployments" class="content scaffold-create" role="main">
